...
<main class="container">
    <div class="form-container">
        ...
        <?php if (!empty($error_message)): ?>
            <div class="alert alert-danger" style="color: red; text-align: center; margin-bottom: 1rem;"><?php echo $error_message; ?></div>
        <?php endif; ?>
        ...
        <form action="/update_order.php?id=<?php echo $order_id; ?>&page=<?php echo $page; ?>" method="POST">
            ...
            <!-- Order Items -->
            <div class="order-items-container" style="margin-top: 2rem;">
                <h2>訂單品項</h2>
                <div class="order-item-header" style="display: grid; grid-template-columns: 4fr 1fr 2fr auto; gap: 1rem; font-weight: 600; padding-bottom: 0.5rem; border-bottom: 1px solid #dee2e6; margin-bottom: 1rem;">
                    <div>產品</div>
                    <div style="text-align: right;">數量</div>
                ...
                <button type="button" class="btn btn-primary" id="add-item-btn" style="margin-top: 1rem;">新增品項</button>
            </div>
            
            <!-- Total Price -->
            <div id="total-price-display" style="text-align: right; font-size: 1.5rem; font-weight: 700; margin-top: 2rem;">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function createItemRow(item = { product_id: 0, amount: 1 }) {
            ...
            row.style.gridTemplateColumns = '4fr 1fr 2fr auto';
            row.style.gap = '1rem';
        ...
        if(existingItems.length > 0) {
            ...
            // If the order has no items, add one empty row to start
            createItemRow();
        }
